...
function zoomFig() {
   ...
   zoomWindow = window.open("zoom.htm", "zoomwin", winOptions);
   zoomWindow.focus();
}
...
function addingFav(fig) {
   if (favLimit.length < 5) {
      favLimit.push(zoomWindow.mainFig);
      var area = document.getElementById("areaFig");
      var imgFig = document.createElement("img");
      //imgFig.src = "images/IMG_0" + photoOrder[2] + "sm.jpg";
      imgFig.src = fig;
      imgFig.width = 150;
      imgFig.height = 100;
      imgFig.style.marginLeft = "20px";
      imgFig.style.marginRight = "20px";
      imgFig.style.marginTop = "20px";

      area.style.textAlign = "center";
      area.appendChild(imgFig);
      ...
      removeButton.id = "remBu";
      removeButton.innerHTML = "Remove";
      removeButton.addEventListener('click', function () {
         area.removeChild(imgFig);
         area.removeChild(removeButton);
         area.removeChild(br);
      });
      area.appendChild(removeButton);

      var br = document.createElement("br");
      area.appendChild(br);

      zoomWindow.alert("Picture Favorited!");

      //
   } else {
      zoomWindow.alert("Favorites full. Favorites should be less than 5 to add.");
   }
}
